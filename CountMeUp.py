'''This first scenario was developed to give 10k votes randonmily between
the canditates by randon users. it return the results live in the chart'''
...
# After many tests I found that as it is a simulated counting the best approach is to put the exact amout of votes
limitOfVotes = {
